...
<body class="bg-[#fcfcfc] text-slate-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-500 font-medium uppercase tracking-tighter">East Calaguiman Official</p>
                </div>
            </div>
           ...
           <!--<div class="hidden md:flex gap-8 text-sm font-medium text-slate-600">
                ...
                <a href="#governance" class="hover:text-emerald-600 transition">Governance</a>
                <a href="#contact" class="hover:text-emerald-600 transition">Contact</a>
            </div>-->

            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}" class="text-sm font-semibold text-white bg-emerald-600 px-5 py-2.5 rounded hover:bg-emerald-700 transition shadow-sm">Portal Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-slate-600 hover:text-slate-900">Sign In</a>
                    <!--<a href="{{ route('register') }}" class="text-sm font-semibold text-white bg-slate-900 px-5 py-2.5 rounded hover:bg-slate-800 transition shadow-md">Create Account</a>-->
                @endauth
            </div>
        </div>
    </nav>
    ...
    <header class="relative overflow-hidden pt-16 pb-24 border-b border-slate-100 bg-white">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 items-center gap-16">
            <div>
                <span class="inline-block px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold uppercase tracking-wider mb-6">
                ...
                <p class="text-lg text-slate-600 leading-relaxed mb-10 max-w-lg">
                    The Barangay Resident Information Management system provides a centralized platform for secure document requests, incident reporting, and transparent local governance.
                </p>
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('register') }}" class="bg-emerald-600 text-white px-8 py-4 rounded font-bold hover:bg-emerald-700 transition-all flex items-center gap-2">
...
<div class="relative bg-white border border-slate-200 rounded-2xl p-6 shadow-2xl overflow-hidden group">
    <div class="flex items-center justify-between mb-8 border-b border-slate-50 pb-4">
        ...
        <div class="px-3 py-1 bg-emerald-50 rounded text-[10px] font-bold text-emerald-600 uppercase tracking-widest">
    ...
    <div class="grid grid-cols-3 gap-4 mb-8">
        ...
        <div class="space-y-3">
            ...
            <div class="bg-white border border-slate-100 rounded-lg p-3 flex items-center justify-between shadow-sm">
            ...
            <div class="bg-white border border-slate-100 rounded-lg p-3 flex items-center justify-between shadow-sm opacity-60">
                <div class="flex items-center gap-3">
    ...
    <section id="services" class="py-24 max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="group p-8 bg-white border border-slate-200 rounded-lg hover:border-emerald-500 transition-all cursor-default">
                <div class="w-12 h-12 bg-slate-50 rounded flex items-center justify-center mb-6 group-hover:bg-emerald-50 transition">
                    <svg class="w-6 h-6 text-slate-900 group-hover:text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                </div>
                <h4 class="text-lg font-bold text-slate-900 mb-3">Document Processing</h4>
                <p class="text-sm text-slate-500 leading-relaxed">Securely request Barangay Clearance, Certificates of Residency, and Indigency without the need for physical queues.</p>
            </div>
            ...
            <div class="group p-8 bg-white border border-slate-200 rounded-lg hover:border-emerald-500 transition-all cursor-default">
                ...
                <p class="text-sm text-slate-500 leading-relaxed">Direct digital line to the Barangay Tanod for incident reporting and emergency assistance within the jurisdiction.</p>
            </div>

            <div class="group p-8 bg-white border border-slate-200 rounded-lg hover:border-emerald-500 transition-all cursor-default">
                <div class="w-12 h-12 bg-slate-50 rounded flex items-center justify-center mb-6 group-hover:bg-emerald-50 transition">
                    <svg class="w-6 h-6 text-slate-900 group-hover:text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                </div>
                <h4 class="text-lg font-bold text-slate-900 mb-3">Community Programs</h4>
                <p class="text-sm text-slate-500 leading-relaxed">Official registry for health drives, livelihood seminars, and local assemblies. Stay informed on town hall schedules.</p>
            </div>
        </div>
    </section>
    ...
    <footer id="contact" class="bg-slate-900 text-slate-400 py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-2">
                    ...
                    <p class="max-w-xs text-sm leading-relaxed">
                        The official digital infrastructure for Barangay Resident Information Management. Dedicated to efficient and transparent community service.
                    </p>
                </div>
                <div>
            ...
            <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between gap-4 text-[10px] uppercase font-bold tracking-widest text-slate-600">
